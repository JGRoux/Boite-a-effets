function Output=LowShelvingFilter(Input,Fc,GaindB,Q,Fe)
% LowShelving Filter
...
if GaindB > 0   % Boost
   a0=(1 + sqrt(V0)*Quality*K + V0*K*K) / (1 + Quality*K + K*K);
   a1=                 (2*(V0*K*K - 1)) / (1 + Quality*K + K*K);
   a2=(1 - sqrt(V0)*Quality*K + V0*K*K) / (1 + Quality*K + K*K);
   b0=1;
...
if GaindB < 0   % Cut
   a0=            (1 + Quality*K + K*K) / (1 + sqrt(V0)*Quality*K + V0*K*K);
   a1=                    (2*(K*K - 1)) / (1 + sqrt(V0)*Quality*K + V0*K*K);
   a2=            (1 - Quality*K + K*K) / (1 + sqrt(V0)*Quality*K + V0*K*K);
   b0=1;
   b1=                 (2*(V0*K*K - 1)) / (1 + sqrt(V0)*Quality*K + V0*K*K);
   b2=(1 - sqrt(V0)*Quality*K + V0*K*K) / (1 + sqrt(V0)*Quality*K + V0*K*K);
end
